<?php
  ...
  // 사용자가 json으로 데이터를 보내면 php 언어는 특정 위치에 이 값을 파일로 보관함
  // 그래서 그 파일을 읽어와야 함.
  ...
  // 참고로.. DB에 비밀번호 같은 것을 저장 할 때.. 노출되지 않도록.. 암호화 가능
